...
def publish_trajectory(positions, duration=1.0):
    ...
    traj.joint_names = ['R_index_MCP_joint', 'R_pinky_MCP_joint', 'R_middle_MCP_joint', 
                        'R_ring_MCP_joint', 'R_thumb_MCP_joint2', 'R_thumb_MCP_joint1']
...
if __name__ == '__main__':
    try:
        ...
        # 动作 2
        publish_trajectory([1.2, 0.5, 0.5, 0.5, 0.3, 0], duration=1)
        rospy.sleep(1)
        
        # 动作 3
        publish_trajectory([1.7, 1.7, 1.7, 1.7, 0.3, 0], duration=1)
