...
namespace inspire_hand
{
    ...
    private:
        // helper function
        bool set_1byte(serial::Serial *port, int add, int value);

        // helper function
        bool set_6short(serial::Serial *port, int add, std::vector<int> values);

        // helper function
        std::vector<int> get_6short(serial::Serial *port, int add);

        // helper function
        std::vector<int> get_6byte(serial::Serial *port, int add);
