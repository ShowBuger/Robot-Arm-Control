...
#include <inspire_hand/set_angle_1.h>
...
namespace inspire_hand
{
    ...
    public:
        ...
        bool setANGLE_1_Callback(inspire_hand::set_angle_1::Request &req,
    ...
    private:
        ...
        //角度控制
        bool setANGLE_1(serial::Serial *port, float angle0, float angle1, float angle2, float angle3, float angle4, float angle5);
